...
@section('ContenidoInterfaces') {{-- AQUI SE INDICA LO QUE PONDREMOS DENTRO DEL LAYOUT --}}
    ...
    <div class="caja3 container p-5" id="contenedor">
        ...
        <div class="d-flex w-100 text-center text-white">
            @if ($bolean === FALSE)
                <div>
                    <a href="{{route('infraestructura.index')}}" class="btn btn-warning mx-1 my-1" title="Resumen Equipos">
        ...
        <div class="d-flex align-items-center my-4">
            <a class="btn btn-dark boton me-3" href="{{route("infraestructura.create")}}">Registrar Equipo</a>
    ...
    <script>
        const formBusquedaCodigo = document.getElementById("formBusquedaTipo");

        formBusquedaCodigo.addEventListener("submit", (e) => {
            const tipoEquipo = formBusquedaCodigo.querySelector('select[name="tipo_elemento"]');
